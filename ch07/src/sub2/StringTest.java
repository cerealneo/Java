...
public class StringTest {
	public static void main(String[] args) {
		...
		System.out.println("message 문자열 1번쨰 문자 : "+c1);
		System.out.println("message 문자열 7번쨰 문자 : "+c2);
		
		//문자열 자르기
		String sub1 = message.substring(0,5);
		String sub2 = message.substring(6);
		System.out.println("message 문자열 0 ~ 5까지의 문자열 : "+sub1);
		System.out.println("message 문자열 6 ~ 마지막까지의 문자열 : "+sub2);
